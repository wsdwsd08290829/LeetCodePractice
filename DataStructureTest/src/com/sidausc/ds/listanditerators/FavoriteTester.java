...
public class FavoriteTester {
  public static void main(String[] args) throws InvalidPositionException, EmptyListException, BoundaryViolationException {
    ...
    try {
      String popular = L2.top(1).iterator().next(); // most popular URL in L1
