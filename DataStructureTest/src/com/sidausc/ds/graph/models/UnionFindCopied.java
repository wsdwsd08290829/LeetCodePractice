...
public class UnionFindCopied{
    ...
    /* (non-Javadoc)
	 * @see com.sidausc.ds.graph.models.UnionFindInterface#find(int)
	 */
    ...
    /* (non-Javadoc)
	 * @see com.sidausc.ds.graph.models.UnionFindInterface#count()
	 */
    ...
    /* (non-Javadoc)
	 * @see com.sidausc.ds.graph.models.UnionFindInterface#connected(int, int)
	 */
    ...
    /* (non-Javadoc)
	 * @see com.sidausc.ds.graph.models.UnionFindInterface#union(int, int)
	 */
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        int N = s.nextInt();
        UnionFindCopied uf = new UnionFindCopied(N);
        while (s.hasNext()) {
            int p = s.nextInt();
            int q = s.nextInt();
        ...
        for(int i= 0; i< 10;i++){
        	...
        	System.out.println(i + " " + uf.rank[i]);
        }
